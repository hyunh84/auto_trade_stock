...
class collector():
    ...
    def db_setting(self):
        ...
        # self.engine_bot = create_engine("mysql+mysqldb://bot:" + "1234!@#$" + "@localhost:3306/" + db_name, encoding='utf-8')
        self.engine_bot = create_engine("mysql+mysqldb://hyunh84:" + "s37540086#" + "@hyunh84.synology.me:32323/" + db_name, encoding='utf-8')

        # 데이터베이스에 실행 할 쿼리
        sql = "select * from stock_trade.study01;"
