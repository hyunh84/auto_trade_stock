...
# db 계정
db_id='hyunh84' # [mysql ID를 넣어주세요]
# db ip
db_ip='hyunh84.synology.me'
# db 패스워드
db_passwd='s37540086#' # [mysql password 를 넣어주세요]
...
virtual_accout="8150650311" # [모의투자 계좌번호를 넣어주세요. 주의! 10자리 계좌번호입니다. 모의투자는 8자리 계좌번호 뒤에 11, 실전은 10이 붙어 있음]

# virtual_simul_num 알고리즘의 번호이다. 새로운 알고리즘으로 새롭게 database를 구축해서 운영하고 싶을 경우 번호를 2, 3, 4 ... 순차적으로 올려 주면 된다.
virtual_simul_num=1
virtual_db_name = "virtual_stock"+str(virtual_simul_num)


# 아래는 실전 투자 계좌번호를 넣는다.
real_account=""
real_simul_num=1
real_db_name="real_stock"+str(real_simul_num)
