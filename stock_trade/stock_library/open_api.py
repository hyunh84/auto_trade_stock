...
from stock_library.simulator_func_mysql import *
import datetime
import sys
from PyQt5.QAxContainer import *
from PyQt5.QtCore import *
import time
from stock_library import cf
...
class open_api(QAxWidget):
    ...
    def variable_setting(self):
        ...
        elif self.account_number == cf.virtual_accout:  # 모의1
            logger.debug("모의투자 1!!")
            self.simul_num = cf.virtual_simul_num
            self.db_name_setting(cf.virtual_db_name)
            self.mod_gubun = 1
